...
export const createBtesDisplayResults: CreateDisplayResults = () => {
    const displayResults: DisplayResult[] = [
        ...
        { id: 'btesTField', title: 'BTES field temperatures', path: '/btes/t-avg-field-hourly-A4.png', data: { status: 'not-downloaded' } },
