...
export const createPtesDisplayResults: CreateDisplayResults = () => {
    const displayResults: DisplayResult[] = [
        ...
        { id: 'ptesBalance', title: 'PTES energy balance', path: '/ptes/balance-monthly-A4.png', data: { status: 'not-downloaded' } },
        { id: 'ptesSoc', title: 'PTES state of charge (SoC)', path: '/ptes/soc-hourly-A4.png', data: { status: 'not-downloaded' } },
        { id: 'ptesT', title: 'PTES temperatures', path: '/ptes/t-ptes-hourly-A4.png', data: { status: 'not-downloaded' } },
