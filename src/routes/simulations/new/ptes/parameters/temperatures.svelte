...
dtHeatPumpBoiler = temperatures.heat_pump_output_setpoint_degC - temperatures.boiler_output_setpoint_degC;
dtStorageMaxHeatPump = temperatures.storage_maximum_degC - temperatures.heat_pump_output_setpoint_degC;
dtCollectorStorageMax = temperatures.output_temperature_setpoint_degC - temperatures.storage_maximum_degC;
}
}
...
const temperature = parseTemperature(inputElement.value, temperatures.output_temperature_setpoint_degC);
...
>{mode === 'absolute' ? $t('common.boilerOutputSetpointTemperature') : 'DT boiler-demand'}</label
>
<div class="input-group input-group-divider grid grid-cols-[--input-unit-grid-cols]">
<input
class="input"
id="boiler-output-setpoint-temperature"
title={mode === 'absolute' ? $t('common.boilerOutputSetpointTemperature') : 'DT boiler-demand'}
type="number"
...
>{mode === 'absolute' ? $t('common.heatPumpOutputSetpointTemperature') : 'DT heat pump-boiler'}</label
>
<div class="input-group input-group-divider grid grid-cols-[--input-unit-grid-cols]">
<input
class="input"
id="heat-pump-output-setpoint-temperature"
title={mode === 'absolute' ? $t('common.heatPumpOutputSetpointTemperature') : 'DT heat pump-boiler'}
type="number"
...
>{mode === 'absolute' ? $t('common.maximumStorageTemperature') : 'DT maximum storage temperature-heat pump'}</label
>
<div class="input-group input-group-divider grid grid-cols-[--input-unit-grid-cols]">
<input
class="input"
id="maximum-storage-temperature"
title={mode === 'absolute' ? $t('common.maximumStorageTemperature') : 'DT maximum storage temperature-heat pump'}
type="number"
...
>{mode === 'absolute' ? $t('common.collectorOutputSetpointTemperature') : 'DT collector-maximum storage temperature'}</label
>
<div class="input-group input-group-divider grid grid-cols-[--input-unit-grid-cols]">
<input
class="input"
id="collector-output-setpoint-temperature"
title={mode === 'absolute' ? $t('common.collectorOutputSetpointTemperature') : 'DT collector-maximum storage temperature'}
type="number"
value={mode === 'absolute' ? temperatures.output_temperature_setpoint_degC : dtCollectorStorageMax}
min={MIN_TEMPERATURE_DEGC}
max={MAX_TEMPERATURE_DEGC}
on:change={mode === 'absolute' ? onSetCollectorOutputTemperature : onDtCollectorStorageMaxChanged}
/>
<div><span class="flex flex-grow justify-center">{mode === 'absolute' ? '°C' : 'K'}</span></div>
</div>
</div>
